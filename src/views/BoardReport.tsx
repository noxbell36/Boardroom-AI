...
export default function BoardReport({ setCurrentView }: { setCurrentView: (view: string) => void }) {
  return (
    <div className="flex-1 flex flex-col min-w-0 bg-slate-100 overflow-y-auto">
      ...
      <div className="py-10 px-6 md:px-10 max-w-[900px] mx-auto w-full">
        {/* Document Container */}
        <div className="bg-white rounded-sm shadow-2xl border border-slate-200 overflow-hidden min-h-[1122px] relative">
          ...
          <div className="px-12 pt-12 pb-6 border-b-4 border-slate-900 flex justify-between items-end">
            <div>
              <h1 className="text-3xl font-black text-slate-900 tracking-tight mb-1.5">이사회 결의 안건</h1>
              <p className="text-slate-500 font-serif italic text-[15px]">Board of Directors Resolution Proposal</p>
            </div>
            <div className="text-right">
              <p className="text-slate-900 font-bold text-[13px] mb-1">문서번호: BR-2024-05-001</p>
              <p className="text-slate-500 text-[13px]">작성일자: 2024.05.22</p>
              <p className="text-slate-500 text-[13px]">작성부서: 전략기획실 (AI 검토)</p>
            </div>
          </div>
          ...
          <div className="px-12 py-10 space-y-10">
            {/* 1. 안건명 */}
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-full bg-slate-900 text-white flex items-center justify-center text-[13px]">1</span>
                안건명 (Agenda)
              </h2>
              <div className="bg-slate-50 p-5 rounded-lg border border-slate-200">
                <p className="text-[15px] font-bold text-slate-900">커넥티드카 데이터 플랫폼 구축을 위한 Joint Venture 설립 및 출자 승인의 건</p>
              </div>
            </section>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-full bg-slate-900 text-white flex items-center justify-center text-[13px]">2</span>
                제안 사유 (Background & Purpose)
              </h2>
              <div className="text-slate-700 leading-relaxed text-justify space-y-3 text-[14px]">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-full bg-slate-900 text-white flex items-center justify-center text-[13px]">3</span>
                주요 내용 (Key Details)
              </h2>
              <div className="grid grid-cols-2 gap-5">
                <div className="border border-slate-200 rounded-lg p-4">
                  <h3 className="font-bold text-slate-900 mb-2.5 flex items-center gap-2 text-[14px]">
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-full bg-slate-900 text-white flex items-center justify-center text-[13px]">4</span>
                AI 위원회 심의 결과 요약 (AI Committee Review)
              </h2>
              <div className="bg-blue-50/50 border border-blue-100 rounded-lg p-5">
                <div className="flex items-center justify-between mb-3 pb-3 border-b border-blue-200/50">
                  <div className="flex items-center gap-2">
                    <FileSearch size={18} className="text-blue-700" />
                    <span className="font-bold text-blue-900 text-[14px]">종합 평가: 조건부 승인 (Score: 76/100)</span>
                  </div>
                  <span className="px-2.5 py-0.5 bg-blue-600 text-white text-[11px] font-bold rounded-full">AI Verified</span>
                </div>
            ...
            <section>
              <h2 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2.5">
                <span className="w-7 h-7 rounded-full bg-slate-900 text-white flex items-center justify-center text-[13px]">5</span>
                결의 사항 (Resolution)
              </h2>
              <div className="p-5 border-2 border-slate-900 rounded-lg bg-slate-50">
                <p className="text-[15px] font-bold text-slate-900 text-center leading-relaxed">
          ...
          {/* Signatures */}
          <div className="px-12 pb-20 pt-10 mt-auto">
            <div className="flex justify-end gap-10">
              <div className="text-center">
                <p className="text-slate-500 text-[13px] mb-6">대표이사 (CEO)</p>
                <div className="w-32 border-b border-slate-400 relative">
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-slate-300">
                    <FileSignature size={28} />
                  </span>
                </div>
                <p className="text-slate-900 font-bold mt-2 text-[14px]">(인)</p>
              </div>
              <div className="text-center">
                <p className="text-slate-500 text-[13px] mb-6">이사회 의장 (Chairman)</p>
                <div className="w-32 border-b border-slate-400 relative">
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-slate-300">
                    <FileSignature size={28} />
                  </span>
          ...
          <div className="absolute inset-0 pointer-events-none flex items-center justify-center opacity-[0.03] overflow-hidden">
            <span className="text-[120px] font-black text-slate-900 transform -rotate-45 select-none whitespace-nowrap">BOARDROOM AI</span>
          </div>
        </div>
      </div>
    </div>
